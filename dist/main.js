! function (e) {
    ...
    function c(e, t) {
        for (var n = 0; n < e.length; n++) {
            ...
            if (i) {
                ...
                for (; s < o.parts.length; s++) i.parts.push(b(o.parts[s], t))
            } else {
                var a = [];
                for (s = 0; s < o.parts.length; s++) a.push(b(o.parts[s], t));
                r[o.id] = {
                    id: o.id,
                    refs: 1,
                    parts: a
    ...
    function b(e, t) {
        ...
        if (t.singleton) {
            var f = a++;
            n = s || (s = v(t)), r = m.bind(null, n, f, !1), o = m.bind(null, n, f, !0)
